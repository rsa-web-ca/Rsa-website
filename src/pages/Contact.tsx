    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)]">
            ...
            <div>
              ...
              <div className="mt-8 space-y-8">
                <div className="flex gap-4">
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-surface-raised text-gold-600">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="mt-1 block max-w-sm text-sm leading-relaxed text-ink-soft transition-colors hover:text-gold-600"
                    >
                      {site.address}
                    </a>
                  </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href={site.phoneHref} className="mt-1 block text-sm text-ink-soft transition-colors hover:text-gold-600">
                      {site.phone}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="mt-1 block text-sm text-ink-soft transition-colors hover:text-gold-600"
                    >
                      {site.partnerEmail}
                    </a>
                    <a
                      href={`mailto:${site.email}`}
                      className="mt-0.5 block text-sm text-ink-soft transition-colors hover:text-gold-600"
                    >
                      {site.email}
                    </a>
                  </div>
          ...
          <Reveal delay={100}>
            <div className="rounded-2xl border border-line bg-surface p-6 shadow-lift sm:p-10">
